...
public class TetrisBoard 
{
	...
	// Random color for appearance purpose
	Color pieceColor; 
	 ...
	 * Each time a new piece is added, the blocks has a new random color for decorating purposes
	 */
	public void addNewPiece() 
	{
		// generate a random integer from 1 to 7 because there are 7 types of pieces
		int randomPiece = (int) (1 + (Math.random() * 7));		
		...
		case 1:
			...
			pieceColor = new Color((int)(Math.random() * 0x1000000));
			pieceColor.brighter();
			break;
		case 2:
